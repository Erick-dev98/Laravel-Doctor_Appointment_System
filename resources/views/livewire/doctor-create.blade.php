        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <form wire:submit="register" class="p-5">
                ...
                <div>
                    ...
                    <select wire:model="speciality_id" class="mt-1.5 py-3 px-4 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                 ...
                 <div>
                    ...
                    <x-text-input wire:model="experience" id="experience" class="block mt-1 w-full" type="text" name="experience" autofocus autocomplete="experience" />
                ...
                <div>
                    ...
                    <x-text-input wire:model="linkedin" id="linkedin" class="block mt-1 w-full" type="text" name="linkedin" autofocus autocomplete="linkedin" />
                    <x-input-error :messages="$errors->get('linkedin')" class="mt-2" />
                </div>

                <div class="flex items-center justify-end mt-4">
                    <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-red-600 text-white hover:bg-red-700 focus:outline-none focus:bg-red-700 disabled:opacity-50 disabled:pointer-events-none" href="/admin/doctors">
                        Cancel
                    </a>
